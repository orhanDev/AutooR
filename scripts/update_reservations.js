  ...
  try {
    ...
    const insertResult = await client.query(`
      INSERT INTO reservations (
        ...
        (1, 1, '2025-01-15', '2025-01-17', '10:00:00', '18:00:00', 1, 1, 250.00, 'Abgeschlossen', '{"insurance": true, "gps": false}'),
        (1, 2, '2025-02-01', '2025-02-03', '09:00:00', '17:00:00', 2, 2, 400.00, 'Genehmigt', '{"insurance": true, "gps": true}'),
