...
SELECT 
    ...
    daily_rate,
    CASE 
        WHEN daily_rate BETWEEN 100 AND 140 THEN 'Ekonomi/Kompakt'
        WHEN daily_rate BETWEEN 140 AND 180 THEN 'Orta Segment'
        WHEN daily_rate BETWEEN 180 AND 240 THEN 'Premium Orta'
        WHEN daily_rate BETWEEN 240 AND 320 THEN 'Üst Segment'
        WHEN daily_rate BETWEEN 320 AND 450 THEN 'Lüks'
        WHEN daily_rate BETWEEN 450 AND 650 THEN 'Premium Lüks'
        WHEN daily_rate BETWEEN 650 AND 1200 THEN 'Ultra Lüks'
        ELSE 'Diğer'
    END as segment
FROM cars 
