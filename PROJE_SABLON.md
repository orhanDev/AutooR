...
Kısa açıklama (1-2 cümle). Ne yaptığınızı ve amacını açıklayan özet.

**Teknolojiler:** Teknoloji1, Teknoloji2, Teknoloji3, Teknoloji4

**Özellikler:**
- Özellik 1 (kısa ve öz)
...
**Teknolojiler:** React, Node.js, MongoDB, Stripe API, Express.js

**Özellikler:**
- Ürün kataloğu ve arama fonksiyonu
...
**Teknolojiler:** Next.js, TypeScript, Prisma, PostgreSQL, Tailwind CSS

**Özellikler:**
- Markdown desteği ile içerik yönetimi
...
**Teknolojiler:** Vue.js, Python, Django, SQLite, REST API

**Özellikler:**
- Proje ve görev oluşturma sistemi
...
3. **Özellikleri vurgulayın:** 3-4 önemli özellik yeterli
...
Kurze Beschreibung (1-2 Sätze). Zusammenfassung, die erklärt, was Sie gemacht haben und das Ziel.

**Technologien:** Technologie1, Technologie2, Technologie3, Technologie4
